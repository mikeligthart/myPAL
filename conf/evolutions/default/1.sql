...
alter table carbo_hydrate add constraint fk_carbo_hydrate_user_1 foreign key (user_email) references user (email) on delete restrict on update restrict;
create index ix_carbo_hydrate_user_1 on carbo_hydrate (user_email);
alter table diary_activity add constraint fk_diary_activity_user_2 foreign key (user_email) references user (email) on delete restrict on update restrict;
...
alter table glucose add constraint fk_glucose_user_8 foreign key (user_email) references user (email) on delete restrict on update restrict;
create index ix_glucose_user_8 on glucose (user_email);
alter table insulin add constraint fk_insulin_user_9 foreign key (user_email) references user (email) on delete restrict on update restrict;
create index ix_insulin_user_9 on insulin (user_email);
alter table log_action add constraint fk_log_action_user_10 foreign key (user_email) references user (email) on delete restrict on update restrict;
...
alter table picture add constraint fk_picture_user_12 foreign key (user_email) references user (email) on delete restrict on update restrict;
